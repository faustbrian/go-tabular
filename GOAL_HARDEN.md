# Goal Harden: `go-tabular`

## Purpose

This document tightens the execution bar for `go-tabular` beyond feature scope.
...
`go-tabular` is only ready for serious OSS adoption when it proves all of the
following:
